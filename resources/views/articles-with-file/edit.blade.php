...
@section('content')
    <div class="container">
        <form action="/articles-with-file/{{ $article->id }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <input type="file" class="form-control" name="image" value="{{ $article->featured_image }}"></br>
